...
""));
        ...
        plainTextEdit_7->setStyleSheet(QStringLiteral("font:9pt"));
        ...
        ContinuousBtn->setGeometry(QRect(50, 310, 100, 30));
        ...
        DiscreteBtn->setStyleSheet(QStringLiteral("color:white;"));
        StopBtn = new QPushButton(groupBox);
        StopBtn->setObjectName(QStringLiteral("StopBtn"));
        StopBtn->setEnabled(true);
        StopBtn->setGeometry(QRect(50, 410, 101, 30));
        StopBtn->setMaximumSize(QSize(16777215, 30));
        StopBtn->setStyleSheet(QStringLiteral("color:white;"));
        Face = new QRadioButton(groupBox);
        Face->setObjectName(QStringLiteral("Face"));
        Face->setGeometry(QRect(20, 190, 89, 16));
        Face->setStyleSheet(QStringLiteral("color:white;"));
        Fist = new QRadioButton(groupBox);
        Fist->setObjectName(QStringLiteral("Fist"));
        Fist->setGeometry(QRect(20, 220, 89, 16));
        Fist->setStyleSheet(QStringLiteral("color:white;"));
        horizontalSlider = new QSlider(groupBox);
        horizontalSlider->setObjectName(QStringLiteral("horizontalSlider"));
        horizontalSlider->setGeometry(QRect(20, 260, 160, 22));
